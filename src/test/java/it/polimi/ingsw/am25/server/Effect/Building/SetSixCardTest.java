...
import it.polimi.ingsw.am25.server.model.Effect.Building.SetSixCard;
...
class SetSixCardTest {
    private Player playerP1, playerP2;


    @BeforeEach
    void setUp() {
        playerP1= new Player("Lucio Calzino", COLOR.BLUE);
        playerP2= new Player("Beppina", COLOR.RED);
    }
    ...
    void Set1() {
            ...
            buildingCard.setBuildingEffect(new SetSixCard());
            buildingCard.applyBuildingEffect(playerP1);

            assertEquals(6, playerP1.getPrestigePoint());
    ...
    void Set2() {
        ...
        assertEquals(12, playerP1.getPrestigePoint());
    }
    ...
    void SetIncompleted() {
        ...
        BuildingCard buildingCard= new BuildingCard(ERA.ERA_I, CARD_TYPE.BUILDING, 1, 5, 30, EVENT_TYPE.END_ROUND);
        buildingCard.setBuildingEffect(new SetSixCard());
        buildingCard.applyBuildingEffect(playerP2);

        assertEquals(0, playerP2.getPrestigePoint());
    }
