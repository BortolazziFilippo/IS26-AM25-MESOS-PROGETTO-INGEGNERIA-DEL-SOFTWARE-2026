...
public class PlayerStatusTUI {
    ...
    private String iconName(INV_ICON icon) {
        switch (icon) {
            ...
            case STONE:    return "PIETRA";
            case NECKLACE: return "COLLANA";
            case BAIT:     return "ESCA";
            case GHOST:    return "SPIRITO";
            case ARROW:    return "FRECCIA";
            case LEATHER:  return "CUOIO";
            case ROPE:     return "CORDA";
            case FLUTE:    return "FLAUTO";
            case BOWL:     return "CIOTOLA";
